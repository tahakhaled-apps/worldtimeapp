...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    data= data.isNotEmpty ? data : data =ModalRoute.of(context).settings.arguments;
    //print(data);
    String bgImage = data['isDayTime'] ? 'day.png' :'night.png';
    Color bgColor = data['isDayTime'] ? Colors.cyan[400] :Colors.indigo[900];
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 20.0,),
                  Text(data['time'],style: TextStyle(fontSize: 66.0,color: txtColor),)
                ],
              ),
            ),
          )
